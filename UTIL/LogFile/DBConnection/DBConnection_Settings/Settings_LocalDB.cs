...
namespace LogFile
{
    public  class Log_Settings_LocalDB
    {
        ...
        public Log_Settings_LocalDB(string x_inifile_prefix, int iSettingsIndex)
        {
        ...
        public  bool Load(ref string Err)
        {
            ...
            switch (m_eType)
            {
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported");
                    return false;
                ...
                case eType.IniFile_Setting:
                    ...
                    if (Log_SettingsFunc.IniReadValue_StringArr(section,m_iSettingsIndex, ref sLocalDB_DataBaseFilePath, const_sLocalDB_DataBaseFilePath,ref Err))
                    {
                        if (Log_SettingsFunc.IniReadValue_StringArr(section, m_iSettingsIndex,ref sLocalDB_DataBaseFileName, const_sLocalDB_DataBaseFileName, ref Err))
                        {
                            if (Log_SettingsFunc.IniReadValue_StringArr(section, m_iSettingsIndex,ref sLocalDB_crypted_Password, const_sLocalDB_crypted_Password, ref Err))
                            {
                                return true;
                            }
                        }
        ...
        public  bool Save(ref string Err)
        {
            ...
            {
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported in function Save(ref string Err)");
                    return false;
                ...
                case eType.IniFile_Setting:
                    string section = m_inifile_prefix + const_section_prefix_LocalDB_;
                    if (Log_SettingsFunc.IniWriteValue_StringArr(section,m_iSettingsIndex, sLocalDB_DataBaseFileName, const_sLocalDB_DataBaseFileName, ref Err))
                    {
                        if (Log_SettingsFunc.IniWriteValue_StringArr(section, m_iSettingsIndex, sLocalDB_DataBaseFilePath, const_sLocalDB_DataBaseFilePath, ref Err))
                        {
                            if (Log_SettingsFunc.IniWriteValue_StringArr(section, m_iSettingsIndex, sLocalDB_crypted_Password, const_sLocalDB_crypted_Password, ref Err))
                            {
                                return true;
                            }
                        }
        ...
        public  string LocalDB_DataBaseFilePath()
        {
            switch (m_eType)
            {
                ...
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported in function LocalDB_DataBaseFilePath(ref string Err)");
                    return "ERROR eType.Properties_Settings_Default not suported in function LocalDB_DataBaseFilePath(ref string Err)";
                    //switch (m_iSettingsIndex)
                    //{
                    //    case 0:
                    ...
                    //        break;
                    //    default:
                    //        Error.Show("Error:Settings.(string)LocalDB_DataBaseFilePath:Settings_Index=" + m_iSettingsIndex.ToString() + " not implemented in!");
                    //        return Properties.LocalDB1.Default.LocalDB_DataBaseFilePath;
                    //        break;
                    //}
        ...
        public  string LocalDB_DataBaseFileName()
        {
            switch (m_eType)
            {
                ...
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported in function LocalDB_DataBaseFileName(ref string Err)");
                    return "ERROR eType.Properties_Settings_Default not suported in function LocalDB_DataBaseFileName(ref string Err)";
                    ...
                    //        break;
                    //    default:
                    //        Error.Show("Error:Settings.(string)LocalDB_DataBaseFileName:Settings_Index=" + m_iSettingsIndex.ToString() + " not implemented in!");
                    //        return Properties.LocalDB1.Default.LocalDB_DataBaseFileName;
                    //        break;
                    //}
                    break;
        ...
        public  void LocalDB_DataBaseFileName( string sValue)
        {
            switch (m_eType)
            {
                ...
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported in function LocalDB_DataBaseFileName(string sValue)");
                    return;
                    //switch (m_iSettingsIndex)
                    //{
                    //    case 0:
        ...
        public  string LocalDB_crypted_Password()
        {
            switch (m_eType)
            {
                ...
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported in function LocalDB_crypted_Password()");
                    return "ERROR eType.Properties_Settings_Default not suported in function LocalDB_crypted_Password()";
                ...
                default:
                    Error.Show("Error:Settings.LocalDB_crypted_Password:m_Type not implemented in!");
                    return null;
            }
        }
        ...
        public  void LocalDB_crypted_Password(string sValue)
        {
            switch (m_eType)
            {
                ...
                case eType.Properties_Settings_Default:
                    MessageBox.Show("ERROR eType.Properties_Settings_Default not suported in function LocalDB_crypted_Password(string sValue)");
                    return;
