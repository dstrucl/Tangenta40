...
namespace TangentaSampleDB
{
    public partial class Form_Items_Samples : Form
    {
        ...
        public Form_Items_Samples(NavigationButtons.Navigation xnav,string shopName)
        {
            ...
            if (m_shopName.Equals(lngRPM.s_Shop_B.s))
            {
                this.txt_Item_Name_Prefix.Text = lngRPMS.ShopB_Item_Name_Item.s;
                this.txt_ItemAbbreviationPrefix.Text = lngRPMS.ShopB_Item_Abbreviation_SB.s;
            }
            else
            {
                this.txt_Item_Name_Prefix.Text = lngRPMS.ShopC_Item_Name_Item.s; 
                this.txt_ItemAbbreviationPrefix.Text = lngRPMS.ShopC_Item_Abbreviation_SB.s;
            }
    ...
    private void usrc_NavigationButtons1_ButtonPressed(NavigationButtons.Navigation.eEvent evt)
        {
            ...
            switch (evt)
            {
                case NavigationButtons.Navigation.eEvent.NEXT:
                    ...
                    if (m_shopName.Equals(lngRPM.s_Shop_B.s))
                    {
                        lngRPMS.ShopB_Item_Abbreviation_SB.s = this.txt_ItemAbbreviationPrefix.Text;
                        lngRPMS.ShopB_Item_Name_Item.s = this.txt_Item_Name_Prefix.Text;
                    }
                    else
                    {
                        lngRPMS.ShopC_Item_Abbreviation_SB.s = this.txt_ItemAbbreviationPrefix.Text;
                        lngRPMS.ShopC_Item_Name_Item.s = this.txt_Item_Name_Prefix.Text;
                    }
                    this.Close();
        ...
        private void Form_Items_Samples_Shown(object sender, EventArgs e)
        {
            ...
            {
                if (XMessage.Box.Show(this, lngRPMS.s_IfYouAreRunningThisApplicationOnlyForDemoOrTestPurposesPressYes, lngRPM.s_Question.s, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
                {
