...
namespace LoginControl
{
    public partial class AWPFormSelectMyOrgPer : Form
    {
        ...
        private void btn_Select_Click(object sender, EventArgs e)
        {
            ...
            Transaction transaction_AWPFormSelectMyOrg_btn_Select_Click_InsertNewDefaultLoginUsersRows = DBSync.DBSync.NewTransaction("AWPFormSelectMyOrg.btn_Select_Click.InsertNewDefaultLoginUsersRows");
