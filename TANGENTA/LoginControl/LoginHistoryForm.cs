...
namespace LoginControl
{
    public partial class LoginHistoryForm : Form
    {
        ...
        public LoginHistoryForm(LoginControl logctrl, int Users_id, string UserName)
        {
            ...
            this.lbl_ActiveUsers.Text = lngRPM.s_ActiveUsers.s;
            this.lbl_LoginHistory.Text = lngRPM.s_LoginHistoryForUser.s + UserName;
        }
        ...
        private void LoginHistoryForm_Load(object sender, EventArgs e)
        {
            ...
            if (m_LoginSession_VIEW_active.Read(ref Err))
            {
                ...
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.username.name].HeaderText = lngRPM.s_UserName.s;
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.first_name.name].HeaderText = lngRPM.s_FirstName.s;
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.last_name.name].HeaderText = lngRPM.s_LastName.s;
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.Identity.name].HeaderText = lngRPM.s_IdentityNumber.s;
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.Contact.name].HeaderText = lngRPM.s_Contact.s;
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.Login_time.name].HeaderText = lngRPM.s_LoginTime.s;
                dgv_ActiveUsers.Columns[LoginDB_DataSet.LoginSession_VIEW.Logout_time.name].HeaderText = lngRPM.s_LogoutTime.s;
                ...
                if (m_LoginSession_VIEW_notactive.Read(ref Err))
                {
                    ...
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.username.name].HeaderText = lngRPM.s_UserName.s;
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.first_name.name].HeaderText = lngRPM.s_FirstName.s;
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.last_name.name].HeaderText = lngRPM.s_LastName.s;
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.Identity.name].HeaderText = lngRPM.s_IdentityNumber.s;
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.Contact.name].HeaderText = lngRPM.s_Contact.s;
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.Login_time.name].HeaderText = lngRPM.s_LoginTime.s;
                    dgv_LoginHistory.Columns[LoginDB_DataSet.LoginSession_VIEW.Logout_time.name].HeaderText = lngRPM.s_LogoutTime.s;
                }
                else
                {
