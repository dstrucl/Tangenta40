        ...
        private bool SaveIfChanged()
        {
            if (m_LMOUser.awpld.Changed)
            {
                if (CheckIfUserDefined())
                {
                    ...
                    {
                        Transaction transaction_AWP_UserManager_SaveIfChanged_UpdateAWPLoginData = DBSync.DBSync.NewTransaction("AWP_UserManager.SaveIfChanged.UpdateAWPLoginData");
       ...
       private void AddHandlers()
        ...
        private void Dgvx_UserRoles_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex>=0)
            {
                if (e.ColumnIndex==1)
                {
                    ...
                    //Remove Role
                    Transaction transaction_AWP_UserManager_Dgvx_UserRoles_CellClick_m_LMOUser_awpld_RemoveRole = DBSync.DBSync.NewTransaction("AWP_UserManager.Dgvx_UserRoles_CellClick.m_LMOUser.awpld.RemoveRole");
                    if (m_LMOUser.awpld.RemoveRole(e.RowIndex, transaction_AWP_UserManager_Dgvx_UserRoles_CellClick_m_LMOUser_awpld_RemoveRole))
                    {
                        ...
                        {
                            InitRoles();
                            Transaction transaction_AWP_UserManager_Dgvx_UserRoles_CellClick_GetUserRoles = DBSync.DBSync.NewTransaction("AWP_UserManager.Dgvx_UserRoles_CellClick.GetUserRoles");
        ...
        private void Dgvx_OtherRoles_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    //button MoveRight clicked
                    Transaction transaction_AWP_UserManager_Dgvx_OtherRoles_CellClick_m_LMOUser_awpld_AddRole = DBSync.DBSync.NewTransaction("AWP_UserManager._Dgvx_OtherRoles_CellClick.m_LMOUser.awpld.AddRole");
                    if (m_LMOUser.awpld.AddRole(e.RowIndex, transaction_AWP_UserManager_Dgvx_OtherRoles_CellClick_m_LMOUser_awpld_AddRole))
                    {
                        ...
                        {
                            InitRoles();
                            Transaction transaction_AWP_UserManager_Dgvx_OtherRoles_CellClick_GetUserRoles = DBSync.DBSync.NewTransaction("AWP_UserManager.Dgvx_OtherRoles_CellClick.GetUserRoles");
