                        ...
                        if (LoginCtrl.PasswordMatch(LoginUsers.o_password.password_, txt_Password.Text))
                        {
                            if (LoginUsers.o_ChangePasswordOnFirstLogin.ChangePasswordOnFirstLogin_)
                            {
                                if (Login_Start(LoginUsers))
                                {
                                    ...
                                    {
                                        Transaction transaction_STDLoginForm_DoLogin = DBSync.DBSync.NewTransaction("STDLoginForm.DoLogin");
                                        ...
                                        {
                                            if (transaction_STDLoginForm_DoLogin.Commit())
                                            {
                                        ...
                                        {
                                            transaction_STDLoginForm_DoLogin.Rollback();
