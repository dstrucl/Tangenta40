                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (DBSync.DBSync.ReadDataTable(ref dt, sql, ref Err))
                    {
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            Address_v.Country_ISO_3166_a2_v= tf.set_string(dt.Rows[0]["OrganisationData_$_cadrorg_$_ccouorg_$$Country_ISO_3166_a2"]);
                            Address_v.Country_ISO_3166_a3_v = tf.set_string(dt.Rows[0]["OrganisationData_$_cadrorg_$_ccouorg_$$Country_ISO_3166_a3"]);
                            Address_v.Country_ISO_3166_num_v = tf.set_short(fs.MyConvertToShort(dt.Rows[0]["OrganisationData_$_cadrorg_$_ccouorg_$$Country_ISO_3166_num"]));
