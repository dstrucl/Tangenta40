...
namespace InvoiceDB
{
    public class Basket
    {
        ...
        public void Parse_Atom_ProformaInvoice_Item_Stock(DataTable xdtDraft_ProformaInvoice_Atom_Item_Stock, ref List<object> xAtom_ProformaInvoice_Price_Item_Stock_Data_LIST)
        {
            int i = 0;
        ...
        public bool RemoveFactory(Atom_ProformaInvoice_Price_Item_Stock_Data appisd)
        {
        ...
        public bool Remove_and_put_back_to_ShopShelf(Atom_ProformaInvoice_Price_Item_Stock_Data appisd, ShopShelf shopShelf)
        {
