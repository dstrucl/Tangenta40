...
namespace InvoiceDB
{
    public static class f_cCity_Person
    {
        ...
        internal static bool Get(string_v city_v, ref long_v cCity_Person_ID_v)
        {
            if (city_v != null)
            {
                ...
                if (DBSync.DBSync.ReadDataTable(ref dt, sql, lpar, ref Err))
                {
                    ...
                    else
                    {
                        ...
                        {
                            LogFile.Error.Show("ERROR:InvoiceDB:f_cCity_Person:Get(string_v city_v, ref long_v cCity_Person_ID_v) sql=" + sql + "\r\nErr=" + Err);
                            return false;
                        }
                    }
                }
            ...
            {
                LogFile.Error.Show("ERROR:InvoiceDB:f_cCity_Person:Get(string_v city_v, ref long_v cCity_Person_ID_v) city_v may not be null!");
                return false;
            }
        }
    }
