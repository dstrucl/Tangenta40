...
namespace InvoiceDB
{
    public static class f_cCountry_Org
    {
            ...
            ref long cCountry_Org_ID)
        {
            ...
            string sql = @"select ID from cCountry_Org where Country= " + spar_Country + " and  Country_ISO_3166_a2 = " + spar_Country_ISO_3166_a2 + " and Country_ISO_3166_a3 = " + spar_Country_ISO_3166_a3 + " and Country_ISO_3166_num = " + spar_Country_ISO_3166_num;
            if (DBSync.DBSync.ReadDataTable(ref dt, sql, lpar, ref Err))
            {
                ...
                else
                {
                    ...
                    {
                        LogFile.Error.Show("ERROR:f_cCountry_Org:Get:sql=" + sql + "\r\nErr=" + Err);
                        return false;
                    }
                }
            }
        ...
        internal static bool Get(string_v state_v, string_v state_ISO_3166_a2_v, string_v state_ISO_3166_a3_v, short_v state_ISO_3166_num_v, ref long_v atom_cCountry_Org_ID_v)
        {
            if ((state_v != null) && (state_ISO_3166_a2_v != null) && (state_ISO_3166_a3_v != null) && (state_ISO_3166_num_v != null))
            {
                ...
                string sql = @"select ID from cCountry_Org where Country= " + spar_state_v
                ...
                if (DBSync.DBSync.ReadDataTable(ref dt, sql, lpar, ref Err))
                {
                    ...
                    else
                    {
                        ...
                        if (DBSync.DBSync.ExecuteNonQuerySQLReturnID(sql, lpar, ref cCountry_Org_ID, ref oret, ref Err, "cCountry_Org"))
                        {
                            ...
                            atom_cCountry_Org_ID_v.v = cCountry_Org_ID;
                            return true;
                        }
                        else
                        {
                            LogFile.Error.Show("ERROR:InvoiceDB:f_cCountry_Org:Get(string_v state_v, string_v state_ISO_3166_a2_v, string_v state_ISO_3166_a3_v, short_v state_ISO_3166_num_v, ref long_v atom_cCountry_Org_ID_v)\r\nsql=" + sql + "\r\nErr=" + Err);
                            return false;
                        }
                    }
                }
