...
namespace UpgradeDB
{
    ...
    internal static class Upgrade_1_26_to_1_27
    {
        ...
        internal static object UpgradeDB_1_26_to_1_27(object obj, ref string Err)
        {
            ...
            Transaction transaction_UpgradeDB_1_26_to_1_27 = new Transaction("UpgradeDB_1_26_to_1_27", DBSync.DBSync.MyTransactionLog_delegates);
            cashierActivityList.Clear();
            if (DBSync.DBSync.Drop_VIEWs(ref Err, transaction_UpgradeDB_1_26_to_1_27))
            {
                ...
                if (!DBSync.DBSync.CreateTables(new_tables, ref Err, transaction_UpgradeDB_1_26_to_1_27))
                {
                    return false;
                }
                ...
                if (DBSync.DBSync.Create_VIEWs(transaction_UpgradeDB_1_26_to_1_27))
                {
