...
namespace UpgradeDB
{
    internal static class Upgrade_1_01_to_1_02
    {
        ...
        {
            Transaction transaction_UpgradeDB_1_01_to_1_02 = DBSync.DBSync.NewTransaction("UpgradeDB_1_01_to_1_02");
            ...
            if (DBSync.DBSync.DB_for_Tangenta.DataBase_Make_BackupTemp())
            {
                ...
                {
                    if (DBSync.DBSync.DB_for_Tangenta.DataBase_Create(transaction_UpgradeDB_1_01_to_1_02))
                    {
