    ...
    public partial class Form_Customer_Person_Edit : Form
    {
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            if (usrc_EditTable.Changed)
            {
                ...
                {
                    Transaction transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save = DBSync.DBSync.NewTransaction("Form_Customer_Person_Edit.btn_OK_Click.usrc_EditTable.Save");
                    if (usrc_EditTable.Save(ref transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save))
                    {
        ...
        private void btn_Cancel_Click(object sender, EventArgs e)
        {
            if (usrc_EditTable.Changed)
            {
                ...
                {
                    Transaction transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save = DBSync.DBSync.NewTransaction("Form_Customer_Person_Edit.btn_Cancel_Click.usrc_EditTable.Save");
                    if (usrc_EditTable.Save(ref transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save))
                    {
