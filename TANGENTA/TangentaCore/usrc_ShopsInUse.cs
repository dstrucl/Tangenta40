...
namespace TangentaCore
{
    public partial class usrc_ShopsInUse : UserControl
    {
        ...
        internal bool do_OK()
        {
            ...
            ShopA_Forms.lng.s_ShopA_Name.sText(DynSettings.LanguageID, txt_ShopA_Name.Text);
            ShopB_Forms.lng.s_ShopB_Name.sText(DynSettings.LanguageID, txt_ShopB_Name.Text);
            ShopC_Forms.lng.s_ShopC_Name.sText(DynSettings.LanguageID, txt_ShopC_Name.Text);
