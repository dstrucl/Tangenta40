...
namespace TangentaBooting
{
    public  class Booting_01_TangentaLicence
    {
        ...
        public Booting_01_TangentaLicence(Form xfmain, Startup.Startup x_sturtup)
        {
            frm = xfmain;
            m_startup = x_sturtup;
        ...
        {
            return new startup_step(lng.s_Licence_checked.s, m_startup, Booting.nav,
                                                                                            ...
                                                                                            ref string Err)
        {
            switch (eExitResult)
            {
                ...
                default:
                    LogFile.Error.Show("ERROR:Tangenta:Form:onformresult_TangentaLicence  xnav.eExitResult = " + eExitResult.ToString() + " not implemented");
