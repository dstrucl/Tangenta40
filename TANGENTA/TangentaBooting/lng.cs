...
namespace TangentaBooting
{
    public static class lng
    {
        ...
        public static ltext s_RealyWantToExitProgram = new ltext(new string[] { "Do you realy want to end program? (Yes/No)", "Želite končati program? (Da/Ne)" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs
        public static ltext s_Startup_Tangenta_About = new ltext(new string[] { "Tangenta about", "O programu Tangenta" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs)
        ...
        //public static ltext s_grp_AccessAuthentication = new ltext(new string[] { "Acsess authentification", "Preverjanje osebe prevzema blagajne" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form_ProgramSettings.cs

        //public static ltext s_rdb_Autentification_None = new ltext(new string[] { "None", "brez preverjanja oseba" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form_ProgramSettings.cs

        //public static ltext s_rdb_Autentification_Password = new ltext(new string[] { "Password", "Geslo" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form_ProgramSettings.cs

        //public static ltext s_rdb_Autentification_PIN = new ltext(new string[] { "PIN", "PIN" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form_ProgramSettings.cs

        //public static ltext s_rdb_Autentification_RFID = new ltext(new string[] { "RFID", "RFID" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form_ProgramSettings.cs
        ...
        ////public static ltext s_GoToPreviousStartupStep = new ltext(new string[] { "Go to previous startup step", "Pojdi na prejšni korak" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        ////public static ltext s_GoToNextStartupStep = new ltext(new string[] { "Go to next startup step", "Nadaljuj na naslednji korak" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        ////public static ltext s_GoToExitProgram = new ltext(new string[] { "Exit program", "Končaj program" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs



        public static ltext s_Licence_checked = new ltext(new string[] { "Tangenta licence checked", "Licenca Tangente potrjena" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs)

        public static ltext s_Startup_Check_DBType = new ltext(new string[] { "Get DB type", "Vrsta podatkovne baze" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_Check_DBConnection = new ltext(new string[] { "Connection to Database", "Povezava do podatkovne baze" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_Check_DBSettings = new ltext(new string[] { "Read DB Settings", "Nastavitve podatkovne baze" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_Check_myOrganisation_Data = new ltext(new string[] { "My Organisation data", "Podatki o moji organizaciji" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_GetOrganisationData = new ltext(new string[] { "Reading organisation data ", "Branje podatkov o vaši organizaciji" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_Get_ProgramSettings = new ltext(new string[] { "Get program settings", "Programske nastavitve" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_SetShopsPricelists = new ltext(new string[] { "Set shop's priselists", "Branje cenikov" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_GetBaseCurrency = new ltext(new string[] { "Getting default currency", "Pridobivanje privzete valute" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_GetTaxation = new ltext(new string[] { "Reading default taxation", "Branje davčnih stopenj" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_GetShopB_Items = new ltext(new string[] { "Reading ShopB Items", "Branje artiklov/storitev trgovine B" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_GetShopC_Items = new ltext(new string[] { "Reading ShopC Items", "Branje artiklov/storitev trgovine C" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_GetPrinter = new ltext(new string[] { "Get Printers", "Nastavitve tiskanja" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        public static ltext s_Startup_Login = new ltext(new string[] { "Login", "Prijava" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        //public static ltext s_Previous = new ltext(new string[] { "Previous", "Nazaj" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs


        ////public static ltext s_Next = new ltext(new string[] { "Next", "Naprej" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs

        ////public static ltext s_Tangenta = new ltext(new string[] { "Tangenta", "Tangenta" });   // referenced in C:\Tangenta40\TANGENTA\Tangenta\Form.cs
