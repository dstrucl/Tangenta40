...
namespace TangentaBooting
{
    public class Booting_00_TangentaAbout
    {
        ...
        public Booting_00_TangentaAbout(Form xfmain, Startup.Startup x_sturtup)
        {
            frm = xfmain;
            m_startup = x_sturtup;
        ...
        {
            return new startup_step(lng.s_Startup_Tangenta_About.s, m_startup, Booting.nav, 
                                                                                            ...
                                                                                            ref string Err)
        {
            switch (eExitResult)
            {
                ...
                default:
                    LogFile.Error.Show("ERROR:Tangenta:Form:onformresult_TangentaAbout  xnav.eExitResult = " + eExitResult.ToString() + " not implemented");
