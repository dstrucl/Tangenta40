...
namespace DocumentManager
{
    public partial class Form_ShowShops : Form
    {
        ...
        public Form_ShowShops(DocumentEditor x_docE,SettingsUserValues xSettingsUserValues)
        {
            const int TOPM = 10;
            const int YDIST = 10;
            const int BDIST = 60;
        ...
        {
            this.Top = docE.btn_Show_Shops.Top + docE.btn_Show_Shops.Height;
            this.Left = docE.btn_Show_Shops.Left;
        }
    }
}
