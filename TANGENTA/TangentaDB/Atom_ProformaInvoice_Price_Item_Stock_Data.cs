    ...
    public class Atom_DocInvoice_ShopC_Item_Price_Stock_Data
    {
                            ...
                            ref List<object> DocInvoice_ShopC_Item_Data_list)
        {
            ...
            if (ID.Validate(Atom_Item_ID))
            {
                ...
                DocInvoice_ShopC_Item_ID = new ID(dria[DocInvoice+"_ShopC_Item_ID"]);
                DocInvoice_ID = new ID(dria[DocInvoice+"_ID"]);
                ...
                Atom_Warranty_ID = new ID(dria["Atom_Warranty_ID"]);
                ...
                Atom_Expiry_ID = new ID(dria["Atom_Expiry_ID"]);
        ...
        public void Set(object xusrc_Item, Item_Data xItem_Data,ID xDocInvoice_ID, decimal xFactoryQuantity, decimal xStockQuantity, bool b_from_factory)
        {
            m_ShopShelf_Source.Clear();
            ...
            Item_ID= new ID(xItem_Data.Item_ID);//tf.set_long(dr["Item_ID"]);
