...
namespace TangentaDB
{
    public class Basket
    {
        public class sql_select_Doc_ShopC_Item_Column
        {
    ...
    @"
            ...
            {
                LogFile.Error.Show("ERROR:TangentaDB:Basket:Read_Doc_ShopC_Item_Table:xDocTyp=" + xDocTyp+" not implemented.");
                return false;
            }
            Basket_Doc_ShopC_Item_LIST.Clear();
            ...
            {
                LogFile.Error.Show("ERROR:TangentaDB:Basket:Read_Doc_ShopC_Item_Table:sql=" + sql_select_Doc_ShopC_Item + ":\r\n Err=" + Err);
                return false;
            }
        }
        ...
        public bool RemoveFromBasket_And_put_back_to_Stock(string docTyp, ID doc_ID, decimal xquantity2Remove, Item_Data xData, Transaction transaction)
        {
            ...
            {
                LogFile.Error.Show("ERROR:TangentaDB:Basket:RemoveFromBasket_And_put_back_to_Stock:Doc_ShopC_Item is null!");
            }
        ...
        public void Remove(ID doc_ShopC_Item_ID)
        {
            ...
            {
                if (dscix.Doc_ShopC_Item_ID.Equals(doc_ShopC_Item_ID))
                {
                    this.Basket_Doc_ShopC_Item_LIST.Remove(dscix);
                    return;
                }
            }
        }
        ...
        {
            if (this.Basket_Doc_ShopC_Item_LIST != null)
            {
                if (this.Basket_Doc_ShopC_Item_LIST.Count > 0)
                {
                    foreach (object o in this.Basket_Doc_ShopC_Item_LIST)
                    {
                        if (((Doc_ShopC_Item)o).Atom_Item_UniqueName_v.v.Equals(item_UniqueName))
                        {
                            return true;
                        }
                    }
        ...
        {
            foreach (Doc_ShopC_Item dscix in xdsci_List)
            {
                if (dscix is Doc_ShopC_Item)
                {
                    ...
                    else
                    {
                        ...
                        return eCopy_Doc_ShopC_Item_Result.ERROR_NO_ITEM_IN_DB;
                    }
            ...
            return eCopy_Doc_ShopC_Item_Result.OK;
        }
        ...
        public Doc_ShopC_Item Contains(Item_Data m_Item_Data)
        {
            foreach (object o in this.Basket_Doc_ShopC_Item_LIST)
            {
                if (((Doc_ShopC_Item)o).Atom_Item_UniqueName_v.v.Equals(m_Item_Data.Item_UniqueName_v.v))
                {
                    return ((Doc_ShopC_Item)o);
                }
            }
