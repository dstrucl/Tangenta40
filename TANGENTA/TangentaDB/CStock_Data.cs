...
{
    public class CStock_Data
    {
        private ID m_Consumption_ShopC_Item_ID = null;
        public ID Consumption_ShopC_Item_ID
        {
            get
            {
                return m_Consumption_ShopC_Item_ID;
            }
            set
            {
                m_Consumption_ShopC_Item_ID = value;
            }
        }
        ...
        public CStock_Data()
        {
            m_Consumption_ShopC_Item_ID = null;
            Stock_ID = null;
