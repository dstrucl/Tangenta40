...
{
    public class Consumption_ShopC_Item_Data
    {
        ...
        public Consumption_ShopC_Item_Data(ID xDocInvoice_ID, ID xDocInvoice_ShopC_Item_ID, ID xDocProformaInvoice_ID, ID xDocProformaInvoice_ShopC_Item_ID)
        {
