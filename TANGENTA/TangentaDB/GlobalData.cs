...
namespace TangentaDB
{
    public static class GlobalData
    {
        ...
        public static JOURNAL_Consumption_Type_definitions JOURNAL_Consumption_Type_definitions = null;
        ...
        public static void Init()
        {
            ...
            JOURNAL_Consumption_Type_definitions = new JOURNAL_Consumption_Type_definitions();
...
//            XMessage.Box.Show(cmb_FinancialYear, "after SelectFinancialYear=" + Default_FinancialYear.ToString(), "GlobalData:SetFinancialYears(..)");
        ...
        public static bool Type_definitions_Read()
        {
            ...
            Transaction transaction_Type_definitions_Read = DBSync.DBSync.NewTransaction("Type_definitions_Read");
        ...
        public static bool Get_ElectronicDevice_depended_definitions()
        {
            ...
            {
                Transaction transaction_termsOfPayment_definitions_InsertDefault = DBSync.DBSync.NewTransaction("termsOfPayment_definitions_InsertDefault");
    ...
    private static bool Doc_type_definitions_Read(Transaction transaction)
        ...
        private static bool JOURNAL_type_definitions_Read(Transaction transaction)
        {
            if (GlobalData.JOURNAL_DocInvoice_Type_definitions.Read(transaction))
            {
                ...
                {
                    if (GlobalData.JOURNAL_Consumption_Type_definitions.Read(transaction))
                    {
                        return true;
                    }
                }
