    ...
    public static class myOrg
    {
        ...
        public static myOrg_Office.eGet_m_myOrg_Person_SingleUser_Result Get_m_myOrg_Office_m_myOrg_Person_SingleUser()
        {
            if (m_myOrg_Office!=null)
            {
                ...
                {
                    Transaction transaction_Get_m_myOrg_Person_SingleUser = DBSync.DBSync.NewTransaction("Get_m_myOrg_Person_SingleUser");
                                                                ...
                                                                ref bool Program_m_CountryHasFVI)
        {
            if (myOrg.Get())
            {
                ...
                Transaction transaction_MyOrg_GetOrganisationData = DBSync.DBSync.NewTransaction("MyOrg_GetOrganisationData");
