...
namespace TangentaDB
{
    ...
    {
        public static bool Get(ID cHouseNumber_Person_ID, ref ID Atom_cHouseNumber_Person_ID)
        {
            string Err = null;
        ...
        internal static bool Get(string_v houseNumber_v, ref ID atom_cHouseNumber_Person_ID)
        {
