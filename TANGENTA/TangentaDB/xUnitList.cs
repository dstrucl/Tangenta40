...
namespace TangentaDB
{
    public class xUnitList
    {
        ...
        public xUnitList()
        {
            m_DefaltUnitList.Add(new xUnit(1, "komad", "kom.", 0,true, "Artikli kot komadi."));
            m_DefaltUnitList.Add(new xUnit(2,  "ura", "h", 2,false, "Za vse, kar se meri v urah"));
            m_DefaltUnitList.Add(new xUnit(3,  "dan", "dan", 2, false, "Za vse, kar se meri v dnevih"));
            m_DefaltUnitList.Add(new xUnit(4, "mesec", "mes", 2, false, "Za vse, kar se meri v mesecih"));
            m_DefaltUnitList.Add(new xUnit(5, "leto", "mes", 2,false, "Za vse, kar se meri v mesecih"));
            m_DefaltUnitList.Add(new xUnit(6, "meter", "m", 2, true, "Za kar se, prodaja na dolžinsko enoto"));
            m_DefaltUnitList.Add(new xUnit(7, "kvadratni meter", "m2", 2, true, "Za vse kar se prodaja glede na površino"));
            m_DefaltUnitList.Add(new xUnit(8, "kubični meter", "m3", 2, true, "Za vse kar se prodaja glede na prostornino"));
            m_DefaltUnitList.Add(new xUnit(9, "kilowatna ura", "kWh", 2, false, "Prodaja energije"));
            m_DefaltUnitList.Add(new xUnit(10, "kilometrina", "km", 0, false, "Obračun kilometrine"));
            m_DefaltUnitList.Add(new xUnit(11, "kilogram", "kg", 2, true, "Masa artikla"));
            m_DefaltUnitList.Add(new xUnit(12, "liter", "l", 2, true, "Za snovi, ki se prodajajo glede na prostornino"));
        }
    ...
    public class xUnit
    {
        ...
        public xUnit(int xIndex,string xName, string xSymbol, int xDecimalPlaces,bool xStorageOption, string xDescription)
        {
            m_Index = xIndex;
            m_Name = xName;
            m_Symbol = xSymbol;
