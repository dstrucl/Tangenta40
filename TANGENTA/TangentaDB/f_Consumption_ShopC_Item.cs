...
namespace TangentaDB
{
    public static class f_Consumption_ShopC_Item
    {
        ...
        {
            string sql = "delete from Consumption_ShopC_Item where ID = " + doc_ShopC_Item_ID.ToString();
            string Err = null;
