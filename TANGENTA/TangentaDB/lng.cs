...
namespace TangentaDB
{
    public static class lng
    {
        ...
        public static ltext s_ThereIsNoItemInStockWithUniqueName = new ltext(new string[] { "There is no Item in Sdock with unique name:", "Na zalogi ni artikla z unikatnim imenom:" });
