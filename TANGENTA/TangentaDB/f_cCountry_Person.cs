            ...
            if ((state_v != null) && (state_ISO_3166_a2_v != null) && (state_ISO_3166_a3_v != null) && (state_ISO_3166_num_v != null))
            {
                ...
                if (DBSync.DBSync.ReadDataTable(ref dt, sql, lpar, ref Err))
                {
                    ...
                    else
                    {
                        ...
                        {
                            LogFile.Error.Show("ERROR:TangentaDB:f_cCountry_Person:Get(string_v state_v, string_v state_ISO_3166_a2_v, string_v state_ISO_3166_a3_v, short_v state_ISO_3166_num_v, ref long_v atom_cCountry_Person_ID_v)\r\nsql=" + sql + "\r\nErr=" + Err);
                            return false;
                        }
                    }
                }
