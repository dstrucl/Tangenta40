...
namespace TangentaDB
{
    ...
    {
        public static bool Get(string Name_ParentGroup1, string Name_ParentGroup2, string Name_ParentGroup3, ref ID Item_ParentGroup1_ID, Transaction transaction)
        {
            ...
            if (Name_ParentGroup2 != null)
            {
                ...
                if (f_Item_ParentGroup2.Get(Name_ParentGroup2, Name_ParentGroup3, ref Item_ParentGroup2_ID, transaction))
                {
                    ...
                    if (DBSync.DBSync.ReadDataTable(ref dt, sql, lpar, ref Err))
                    {
                        ...
                        else
                        {
                            ...
                            if (transaction.ExecuteNonQuerySQLReturnID(DBSync.DBSync.Con,sql, lpar, ref Item_ParentGroup1_ID, ref Err, "Item_ParentGroup1"))
                            {
                                return true;
                            }
                            else
