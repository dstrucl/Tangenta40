...
namespace TangentaDB
{
    public static class f_Consumption_ShopC_Item_Source
    {
        ...
        public static bool Get(ID docInvoice_ShopC_Item_ID,ref DataTable dt)
        {
            ...
            dt = new DataTable();
            string sql = @" select
                                   discis.Consumption_ShopC_Item_ID as Doc_ShopC_Item_ID,
                                  ...
                                  from Consumption_ShopC_Item_Source discis
                                  ...
                                  where discis.Consumption_ShopC_Item_ID = " + docInvoice_ShopC_Item_ID.ToString();
        ...
        public static bool Get(ID docInvoice_ShopC_Item_Source_ID, ref Doc_ShopC_Item_Source xdsciS)
        {
            ...
            if (DBSync.DBSync.ReadDataTable(ref dt, sql, ref Err))
            {
                ...
                {
                    LogFile.Error.Show("ERROR:TangentaDB:f_Consumption_ShopC_Item_Source:Get:sql=" + sql + "\r\nNo Consumption_ShopC_Item data for ID = " + docInvoice_ShopC_Item_Source_ID.ToString());
                    return false;
                }
            }
            else
        ...
        public static bool GetItem_Source(ID Consumption_ShopC_Item_ID, ref DataTable dtShopCItems)
        {

 
            string sql = @"select 
                                   
                                   discis.ID as Consumption_ShopC_Item_Source_ID,
                                   discis.dQuantity,
                                   discis.Stock_ID,
                                   i.UniqueName as Item_UniqueName,
                                  ...
                                  where discis.Consumption_ShopC_Item_ID = " + Consumption_ShopC_Item_ID.ToString();
            ...
            {
                LogFile.Error.Show("ERROR:TangentaDB:f_Consumption_ShopC_Item_Source:GetItems:sql=" + sql + "\r\nErr" + Err);
                return false;
            }
        }
        ...
        {
            string sql = "delete from Consumption_ShopC_Item_Source where ID = " + doc_ShopC_Item_Source_ID.ToString();
            string Err = null;
        ...
        public static bool GetItems(ID Doc_ShopC_Item_ID,ID item_ID, ref DataTable dtShopCItems)
        {
            string sql = @"select 
                                  ...
                                  left join StockTake st on ppi.StockTake_ID = st.ID
								  left join Item i on i.ID = ppi.Item_ID
                                  where discis.Consumption_ShopC_Item_ID =" + Doc_ShopC_Item_ID.ToString() + " and ppi.Item_ID = "+ item_ID.ToString()
