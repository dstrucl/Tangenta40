...
namespace Tangenta
{
    public partial class usrc_DocumentMan1366x768 : UserControl
    {
        ...
        {
            get { return m_usrc_DocumentEditor1366x768.m_mode == usrc_DocumentEditor1366x768.emode.view_eDocumentType; }
        }
        ...
        public string DocTyp
        {
            ...
            set
            {
                ...
                {
                    m_DocTyp = s;
                    m_usrc_DocumentEditor1366x768.DocTyp = s;
        ...
        internal void WizzardShow_InvoiceTable_Visible(bool bvisible)
        {
            if (bvisible)
            {
                SetMode(usrc_DocumentMan1366x768.eMode.Shops_and_InvoiceTable);
            }
            else
            {
                SetMode(usrc_DocumentMan1366x768.eMode.Shops);
            }
        ...
        internal bool SetDocument()
        {
            ...
            int iRowsCount = this.m_usrc_TableOfDocuments.Init(m_usrc_DocumentEditor1366x768.DocTyp, false, true, mSettingsUserValues.FinancialYear,null);
            ...
            if (!m_usrc_DocumentEditor1366x768.Init(this.m_usrc_TableOfDocuments.Current_Doc_ID))
            {
                Program.Cursor_Arrow();
                return false;
            }
        ...
        private void Cmb_FinancialYear_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (drv["FinancialYear"] is int)
            {
                ...
                if (iFinancialYear != mSettingsUserValues.FinancialYear)
                {
                    ...
                    SetFinancialYears();
                    this.m_usrc_TableOfDocuments.Init(m_usrc_DocumentEditor1366x768.DocTyp, false,false, mSettingsUserValues.FinancialYear,null);
                }
            }
        }
        ...
        private void m_usrc_Invoice_DocInvoiceSaved(ID DocInvoice_id)
        {
            ...
            this.m_usrc_TableOfDocuments.Init(m_usrc_DocumentEditor1366x768.DocTyp,false,false, mSettingsUserValues.FinancialYear, Doc_ID_to_show_v);
        ...
        private void m_usrc_Invoice_DocProformaInvoiceSaved(ID DocProformaInvoice_id)
        {
            ...
            this.m_usrc_TableOfDocuments.Init(m_usrc_DocumentEditor1366x768.DocTyp, false, false, mSettingsUserValues.FinancialYear, Doc_ID_to_show);
            m_LMOUser.ReloadAdministratorsAndUserManagers();
        }
        ...
        public void Reload()
        {
            ...
            SetMode(eMode.Shops_and_InvoiceTable);
            ID Doc_ID_to_show_v = null;
            if (m_usrc_DocumentEditor1366x768.m_ShopABC != null)
            {
                if (m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc != null)
                {
                    if (ID.Validate(m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID))
                    {
                        Doc_ID_to_show_v = new ID(m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID);
                    }
                    this.m_usrc_TableOfDocuments.Init(m_usrc_DocumentEditor1366x768.DocTyp, false, false, mSettingsUserValues.FinancialYear, Doc_ID_to_show_v);
                }
            }
        ...
        private void New_Empty_Doc(xCurrency currency,ID xAtom_Currency_ID, WArea workArea)
        {
            ...
            if (cmb_DocType.SelectedItem is DocType)
            {
                ...
                if (cmb_FinancialYear.SelectedItem is System.Data.DataRowView)
                {
                    ...
                    {
                        Program.Cursor_Wait();
                        m_usrc_DocumentEditor1366x768.SetNewDraft(m_LMOUser, DocTyp, FinancialYear, currency, xAtom_Currency_ID, workArea);
        ...
        private bool ReadShopABC_items(ref List<object> xShopC_Data_Item_List, ref DataTable xdt_ShopB_Items, ref DataTable xdt_ShopA_Items)
        {
            ...
            if (this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.m_Basket.Read_ShopC_Price_Item_Stock_Table(DocTyp, this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID, ref xShopC_Data_Item_List))
            {
                ...
                if (this.m_usrc_DocumentEditor1366x768.m_ShopABC.Read_ShopB_Price_Item_Table(this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID, ref xdt_ShopB_Items))
                {
                    ...
                    if (ShopA_dbfunc.dbfunc.Read_ShopA_Price_Item_Table(DocTyp, this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID, ref xdt_ShopA_Items))
                    {
                        return true;
                    }
                }
        ...
        {
            if (ShopA_dbfunc.dbfunc.Write_ShopA_Price_Item_Table(DocTyp, this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID, xdt_ShopA_Items))
            {
                if (this.m_usrc_DocumentEditor1366x768.m_ShopABC.Copy_ShopB_Price_Item_Table(this.DocTyp, this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.Doc_ID, xdt_ShopB_Items))
                {
                                                                                                                    ...
                                                                                                                    this.m_usrc_DocumentEditor1366x768.m_usrc_ShopC.proc_Item_Not_In_Offer))
                    {
                        case TangentaDB.Basket.eCopy_ShopC_Price_Item_Stock_Table_Result.OK:
                            ...
                            m_usrc_TableOfDocuments.Init(doc_type, true, false, this.m_usrc_DocumentEditor1366x768.m_ShopABC.m_CurrentDoc.FinancialYear, null);
                            cmb_FinancialYear.SelectedIndexChanged -= Cmb_FinancialYear_SelectedIndexChanged;
            ...
            if (this.Check_NumberOfMonthAfterNewYearToAllowCreateNewInvoice(xFinancialYear))
            {
                ...
                if (cmb_DocType.SelectedItem is DocType)
                {
                    ...
                    if (cmb_FinancialYear.SelectedItem is System.Data.DataRowView)
                    {
                        ...
                        {
                            m_usrc_DocumentEditor1366x768.SetNewDraft(m_LMOUser,xdocType, xFinancialYear, currency, xAtom_Currency_ID,null);
                            DateTime dtStart = DateTime.Now;
                            DateTime dtEnd = DateTime.Now;
                            m_usrc_TableOfDocuments.SetTimeSpanParam(usrc_TableOfDocuments.eMode.All, dtStart, dtEnd);
                ...
                if (cmb_DocType.SelectedItem is DocType)
                {
                    ...
                    if (cmb_FinancialYear.SelectedItem is System.Data.DataRowView)
                    {
                        ...
                        if (ReadShopABC_items(ref xShopC_Data_Item_List, ref xdt_ShopB_Items, ref xdt_ShopA_Items))
                        {
                            ...
                            m_usrc_DocumentEditor1366x768.SetNewDraft(m_LMOUser, New_xdoctyp, xFinancialYear, currency, xAtom_Currency_ID,null);
                            DateTime dtStart = DateTime.Now;
                            DateTime dtEnd = DateTime.Now;
                            m_usrc_TableOfDocuments.SetTimeSpanParam(usrc_TableOfDocuments.eMode.All, dtStart, dtEnd);
        ...
        private void SetDocInvoiceOrDocPoformaInvoice()
        {
            ...
            if (this.IsDocInvoice)
            {
                ...
                {
                    if (this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDI == null)
                    {
                        this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDI = new DocInvoice_AddOn();
                    }
                    this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDI.b_FVI_SLO = Program.b_FVI_SLO;
                    Program.FVI_SLO1.Check_InvoiceNotConfirmedAtFURS(this.m_usrc_DocumentEditor1366x768.m_ShopABC, this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDI, this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDPI);
                }
            }
        }
        ...
        internal bool Initialise(Form_Document main_Form, LoginControl.LMOUser xLMOUser)
        {
            ...
            return m_usrc_DocumentEditor1366x768.Initialise(this, m_LMOUser);
        }
                    ...
                    switch (this.usrc_FVI_SLO1.m_FVI_SLO.Start(ref Err))
                    {
                        ...
                        case FiscalVerificationOfInvoices_SLO.FVI_SLO.eStartResult.ALLREADY_RUNNING:
                            ...
                            if (this.IsDocInvoice)
                            {
                                ...
                                {
                                    this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDI.b_FVI_SLO = Program.b_FVI_SLO;
                                    if (Program.FVI_SLO1.Check_InvoiceNotConfirmedAtFURS(this.m_usrc_DocumentEditor1366x768.m_ShopABC, this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDI, this.m_usrc_DocumentEditor1366x768.m_InvoiceData.AddOnDPI))
                                    {
