...
namespace Tangenta
{
    public partial class usrc_DocInvoice_AddOn : UserControl
    {
        ...
        public bool Init(DocInvoice_AddOn x_AddOnDI, bool bxPrint, usrc_AddOn x_usrc_AddOn) //, int xCurrency_DecimalPlaces, decimal xGrossSum)
        {
            ...
            if (m_AddOnDI.Get(m_usrc_AddOn.m_usrc_Invoice.DocE.m_ShopABC.m_CurrentDoc.Doc_ID))
            {
        ...
        private void btn_Issue_Click(object sender, EventArgs e)
        {
            ...
            {
                if (m_AddOnDI.Set(m_usrc_AddOn.m_usrc_Invoice.DocE.m_ShopABC.m_CurrentDoc.Doc_ID, ref ltMsg))
                {
                    if (Issue != null)
                    {
                        Issue();
