...
namespace Tangenta
{
    ...
    {
        private DataTable dt_Logo = new DataTable();
        ...
        private bool CheckLogoData(ref string Err)
        {
            ...
            if (dbTables.Con.ReadDataTable(ref dt, sql_Logo, ref Err))
            {
                int Count;
                Count = dt.Rows.Count;
                if (Count > 0)
        ...
        private void Form_Logo_Edit_KeyUp(object sender, KeyEventArgs e)
        {
