...
;--- Project Libraries -- 
	...
	File ".\bin\Release\ColorSettings.dll"
	...
	File ".\bin\Release\Cyotek.Windows.Forms.ColorPicker.dll"
	...
	File ".\bin\Release\nunit.framework.dll"
	File ".\bin\Release\ObjectListView.dll"
	File ".\bin\Release\oExcel.dll"
	File ".\bin\Release\OSVer.dll"
	...
	File ".\bin\Release\SelectFile.dll"
	File ".\bin\Release\SelectFolder.dll"
	...
	File ".\bin\Release\System.Management.Automation.dll"
	File ".\bin\Release\TabStrip.dll"
	...
	File ".\bin\Release\UniqueControlNames.dll"
...
;--- Remove Project Libraries -- 
  ...
  Delete $INSTDIR\"ColorSettings.dll"
  ...
  Delete $INSTDIR\"Cyotek.Windows.Forms.ColorPicker.dll"
  ...
  Delete $INSTDIR\"SelectFile.dll"
  Delete $INSTDIR\"SelectFolder.dll"
  ...
  Delete $INSTDIR\"UniqueControlNames.dll"
