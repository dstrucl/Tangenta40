...
namespace Tangenta
{
    public class Booting_05_Check_myOrganisation_Data
    {
                                                            ...
                                                            ref delegate_startup_OnFormResult_proc startup_OnFormResult_proc)
        {
            ...
            startup_OnFormResult_proc = Startup_05_onformresult_ShowmyOrganisation_Data;
        ...
        //    {
        //        case Startup_check_proc_Result.WAIT_USER_INTERACTION:
        ...
        private Startup_onformresult_proc_Result Startup_05_onformresult_ShowmyOrganisation_Data(startup_step myStartup_step,
                                                                                            Form form,
                                                                                            ...
                                                                                            ref string Err)
        {
            switch (eExitResult)
            {
                ...
                default:
                    LogFile.Error.Show("ERROR:Tangenta:FormDocument:onformresult_ShowDataBaseTypeSelectionForm:eExitResult not implemented for xnav.eExitResult = " + eExitResult.ToString());
                    return Startup_onformresult_proc_Result.ERROR;
            }
        }
    }
