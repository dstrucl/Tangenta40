    ...
    public partial class Form_Customer_Person_Edit : Form
    {
        ...
        private bool Init()
        {
            ...
            return usrc_EditTable.Init(dbTables,
                                        ...
                                        tbl, selection, ColumnOrderBy, false, sWhereCondition, mID, false,nav);
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            if (usrc_EditTable.Changed)
            {
                ...
                {
                    Transaction transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save = new Transaction("Form_Customer_Person_Edit.btn_OK_Click.usrc_EditTable.Save", DBSync.DBSync.MyTransactionLog_delegates);
                    if (usrc_EditTable.Save(transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save))
                    {
                        if (!transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save.Commit())
                        {
                            return;
                        }
                    }
                    ...
                    {
                        transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save.Rollback();
                        return;
                    }
                }
            }
        ...
        private void btn_Cancel_Click(object sender, EventArgs e)
        {
            if (usrc_EditTable.Changed)
            {
                ...
                {
                    Transaction transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save = new Transaction("Form_Customer_Person_Edit.btn_Cancel_Click.usrc_EditTable.Save", DBSync.DBSync.MyTransactionLog_delegates);
                    if (usrc_EditTable.Save(transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save))
                    {
                        if (!transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save.Commit())
                        {
                            return;
                        }
                    }
                    ...
                    {
                        transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save.Rollback();
                        return;
                    }
                }
            }
