    ...
    public partial class Form_Customer_Person_Edit : Form
    {
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            if (usrc_EditTable.Changed)
            {
                ...
                {
                    Transaction transaction_Form_Customer_Person_Edit_btn_OK_Click_usrc_EditTable_Save = new Transaction("Form_Customer_Person_Edit.btn_OK_Click.usrc_EditTable.Save");
        ...
        private void btn_Cancel_Click(object sender, EventArgs e)
        {
            if (usrc_EditTable.Changed)
            {
                ...
                {
                    Transaction transaction_Form_Customer_Person_Edit_btn_Cancel_Click_usrc_EditTable_Save = new Transaction("Form_Customer_Person_Edit.btn_Cancel_Click.usrc_EditTable.Save");
