...
namespace ShopB
{
    public partial class usrc_ShopB1366x768 : UserControl
    {
        ...
        {
            m_InvoiceDB.CurrentDocument.Set_SelectedShopB_Items(DocTyp, dgv_SelectedShopB_Items, dt_SelectedShopBItem, dgv_ShopB_Items, dt_Price_ShopBItem);
        }
        ...
        private void ShopBItemSelect(int iShopBItemRow)
        {
            ...
            if (iShopBItemRow >= 0)
            {
                ...
                if (iSelectedShopBItemRow >= 0)
                {
                    ...
                    Transaction transaction_usrc_ShopB1366x768_m_InvoiceDB_Update_SelectedSimpleItem = DBSync.DBSync.NewTransaction("usrc_ShopB1366x768.m_InvoiceDB.Update_SelectedSimpleItem");
                    ...
                    if (m_InvoiceDB.Update_SelectedSimpleItem(PriceShopBItem_Atom_ShopBItem_ID,
                                                           ...
                                                           ref PriceWithoutTax,
                                                           ref Err,
                                                           transaction_usrc_ShopB1366x768_m_InvoiceDB_Update_SelectedSimpleItem))
                    {
                        if (transaction_usrc_ShopB1366x768_m_InvoiceDB_Update_SelectedSimpleItem.Commit())
                        {
                    ...
                    {
                        transaction_usrc_ShopB1366x768_m_InvoiceDB_Update_SelectedSimpleItem.Rollback();
                ...
                else
                {
                    ...
                    Transaction transaction_usrc_ShopB1366x768_ShopBItemSelect_f_Atom_Price_ShopBItem_Get = DBSync.DBSync.NewTransaction("usrc_ShopB1366x768.ShopBItemSelect.f_Atom_Price_ShopBItem.Get");

                    if (f_Atom_Price_ShopBItem.Get(DocTyp,
                                                    Price_ShopBItem_ID,
                                                    m_InvoiceDB.CurrentDocument.Doc_ID,
                                                    ...
                                                    ref Tax,
                                                    ref PriceWithoutTax,
                                                    transaction_usrc_ShopB1366x768_ShopBItemSelect_f_Atom_Price_ShopBItem_Get
                                                    ))
                    {
                        if (transaction_usrc_ShopB1366x768_ShopBItemSelect_f_Atom_Price_ShopBItem_Get.Commit())
                        {
                            if (this.m_InvoiceDB.Read_ShopB_Price_Item_Table(m_InvoiceDB.CurrentDocument.Doc_ID, ref m_InvoiceDB.CurrentDocument.dtCurrent_Atom_Price_ShopBItem))
                            {
                    ...
                    {
                        transaction_usrc_ShopB1366x768_ShopBItemSelect_f_Atom_Price_ShopBItem_Get.Rollback();
                    }
                }
        ...
        private void SelectExtraDiscount(int iSelectedShopBItemRow)
        {
            ...
            if (discount_frm.ShowDialog() == DialogResult.OK)
            {
                ...
                Transaction transaction_usrc_ShopB1366x768_SelectExtraDiscount_m_InvoiceDB_Update_SelectedSimpleItem = DBSync.DBSync.NewTransaction("usrc_ShopB1366x768.SelectExtraDiscount.m_InvoiceDB.Update_SelectedSimpleItem");
                if (m_InvoiceDB.Update_SelectedSimpleItem(Atom_ShopBItem_ID,
                                                        ...
                                                        ref PriceWithoutTax,
                                                        ref Err,
                                                        transaction_usrc_ShopB1366x768_SelectExtraDiscount_m_InvoiceDB_Update_SelectedSimpleItem))
                {
                    if (transaction_usrc_ShopB1366x768_SelectExtraDiscount_m_InvoiceDB_Update_SelectedSimpleItem.Commit())
                    {
                        dt_SelectedShopBItem.Rows[iSelectedShopBItemRow][DBtcn.column_SelectedShopBItem_Count] = iCount;
                        dt_SelectedShopBItem.Rows[iSelectedShopBItemRow][DBtcn.column_SelectedShopBItemPriceWithoutTax] = PriceWithoutTax;
                ...
                {
                    transaction_usrc_ShopB1366x768_SelectExtraDiscount_m_InvoiceDB_Update_SelectedSimpleItem.Rollback();
            ...
            if (iSelectedShopBItemRow >= 0)
            {
                ...
                if (iCount > 1)
                {
                    ...
                    if (GetSelectedShopBItemRowData(lid,
                                                ...
                                                ref Taxation_Rate))
                    {
                        Transaction transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Update_SelectedSimpleItem = DBSync.DBSync.NewTransaction("usrc_ShopB1366x768.ShopBItemDeselect.m_InvoiceDB.Update_SelectedSimpleItem");
                        if (m_InvoiceDB.Update_SelectedSimpleItem(Atom_Price_ShopBItem_ID,
                                       ...
                                       ref PriceWithoutTax,
                                       ref Err,
                                       transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Update_SelectedSimpleItem))
                        {
                            if (transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Update_SelectedSimpleItem.Commit())
                            {
                                dt_SelectedShopBItem.Rows[iSelectedShopBItemRow][DBtcn.column_SelectedShopBItem_Count] = iCount;
                                dt_SelectedShopBItem.Rows[iSelectedShopBItemRow][DBtcn.column_SelectedShopBItemPriceWithoutTax] = PriceWithoutTax;
                                dt_SelectedShopBItem.Rows[iSelectedShopBItemRow][DBtcn.column_SelectedShopBItemPriceTax] = TaxPrice;
                        ...
                        {
                            transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Update_SelectedSimpleItem.Rollback();
                            LogFile.Error.Show("ERROR:usrc_Invoice:ShopBItemDeselect:m_InvoiceDB.Update_SelectedShopBItem:Err=" + Err);
                        }
                    }
                }
                ...
                {
                    Transaction transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Delete_SelectedSimpleItem = DBSync.DBSync.NewTransaction("usrc_ShopB1366x768.ShopBItemDeselect.m_InvoiceDB.Delete_SelectedSimpleItem");
                    if (m_InvoiceDB.Delete_SelectedSimpleItem(Atom_Price_ShopBItem_ID,
                                                            ref Err,
                                                            transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Delete_SelectedSimpleItem))
                    {
                        if (transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Delete_SelectedSimpleItem.Commit())
                        {
                    ...
                    {
                        transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Delete_SelectedSimpleItem.Rollback();
                        LogFile.Error.Show("ERROR:usrc_Invoice:ShopBItemDeselect:m_InvoiceDB.Update_SelectedShopBItem:Err=" + Err);
                    }
        ...
        public bool EditShopBItem()
        {
            ...
            if (edt_ShopBItem_dlg.List_of_Inserted_Items_ID.Count > 0)
            {
                ...
                if (f_PriceList.Check_All_ShopB_Items_In_PriceList(ref dt_ShopB_Items_NotIn_PriceList))
                {
                    ...
                    {
                        Transaction transaction_usrc_ShopB1366x768_EditShopBItem_f_PriceList_Insert_ShopB_Items_in_PriceList = DBSync.DBSync.NewTransaction("usrc_ShopB1366x768.EditShopBItem.f_PriceList.Insert_ShopB_Items_in_PriceList");
                        if (f_PriceList.Insert_ShopB_Items_in_PriceList(dt_ShopB_Items_NotIn_PriceList,
                                        this,
                                        transaction_usrc_ShopB1366x768_EditShopBItem_f_PriceList_Insert_ShopB_Items_in_PriceList))
                        {
                            if (transaction_usrc_ShopB1366x768_EditShopBItem_f_PriceList_Insert_ShopB_Items_in_PriceList.Commit())
                            {
                        ...
                        {
                            transaction_usrc_ShopB1366x768_EditShopBItem_f_PriceList_Insert_ShopB_Items_in_PriceList.Rollback();
                        }
                    }
                }
            }
