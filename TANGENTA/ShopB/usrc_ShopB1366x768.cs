    ...
    public partial class usrc_ShopB1366x768 : UserControl
    {
        ...
        private void ShopBItemSelect(int iShopBItemRow)
        {
            ...
            if (iShopBItemRow >= 0)
            {
                ...
                if (iSelectedShopBItemRow >= 0)
                {
                    ...
                    Transaction transaction_usrc_ShopB1366x768_m_InvoiceDB_Update_SelectedSimpleItem = new Transaction("usrc_ShopB1366x768.m_InvoiceDB.Update_SelectedSimpleItem");
                ...
                else
                {
                    ...
                    Transaction transaction_usrc_ShopB1366x768_ShopBItemSelect_f_Atom_Price_ShopBItem_Get = new Transaction("usrc_ShopB1366x768.ShopBItemSelect.f_Atom_Price_ShopBItem.Get");
        ...
        private void SelectExtraDiscount(int iSelectedShopBItemRow)
        {
            ...
            if (discount_frm.ShowDialog() == DialogResult.OK)
            {
                ...
                Transaction transaction_usrc_ShopB1366x768_SelectExtraDiscount_m_InvoiceDB_Update_SelectedSimpleItem = new Transaction("usrc_ShopB1366x768.SelectExtraDiscount.m_InvoiceDB.Update_SelectedSimpleItem");
            ...
            if (iSelectedShopBItemRow >= 0)
            {
                ...
                if (iCount > 1)
                {
                    ...
                    if (GetSelectedShopBItemRowData(lid,
                                                ...
                                                ref Taxation_Rate))
                    {
                        Transaction transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Update_SelectedSimpleItem = new Transaction("usrc_ShopB1366x768.ShopBItemDeselect.m_InvoiceDB.Update_SelectedSimpleItem");
                ...
                {
                    Transaction transaction_usrc_ShopB1366x768_ShopBItemDeselect_m_InvoiceDB_Delete_SelectedSimpleItem = new Transaction("usrc_ShopB1366x768.ShopBItemDeselect.m_InvoiceDB.Delete_SelectedSimpleItem");
        ...
        public bool EditShopBItem()
        {
            ...
            if (edt_ShopBItem_dlg.List_of_Inserted_Items_ID.Count > 0)
            {
                ...
                if (f_PriceList.Check_All_ShopB_Items_In_PriceList(ref dt_ShopB_Items_NotIn_PriceList))
                {
                    ...
                    {
                        Transaction transaction_usrc_ShopB1366x768_EditShopBItem_f_PriceList_Insert_ShopB_Items_in_PriceList = new Transaction("usrc_ShopB1366x768.EditShopBItem.f_PriceList.Insert_ShopB_Items_in_PriceList");
