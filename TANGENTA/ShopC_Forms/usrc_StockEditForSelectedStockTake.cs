...
namespace ShopC_Forms
{
    public partial class usrc_StockEditForSelectedStockTake : UserControl
    {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            if (Check())
            {
                Transaction transaction_usrc_StockEditForSelectedStockTake_AddItemToStockTake = DBSync.DBSync.NewTransaction("usrc_StockEditForSelectedStockTake.btn_Add_Click.AddItemToStockTake");
        ...
        private void btn_CloseStockTake_Click(object sender, EventArgs e)
        {
            if (ID.Validate(StockTake_ID))
            {
                if (CalculateDifference() == 0)
                {
                    ...
                    {
                        Transaction transaction_usrc_StockEditForSelectedStockTake_btn_CloseStockTake_Click_f_StockTake_Lock = DBSync.DBSync.NewTransaction("usrc_StockEditForSelectedStockTake.btn_CloseStockTake_Click.f_StockTake.Lock");
        ...
        {
            Transaction transaction_usrc_StockEditForSelectedStockTake_RemoveItemFromStockTake_f_Stock_Remove = DBSync.DBSync.NewTransaction("usrc_StockEditForSelectedStockTake.RemoveItemFromStockTake.f_Stock.Remove");
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            if (Check_dQuantity())
            {
                Transaction transaction_usrc_StockEditForSelectedStockTake_btn_Update_Click_UpdateStock = DBSync.DBSync.NewTransaction("usrc_StockEditForSelectedStockTake.btn_Update_Click.UpdateStock");
