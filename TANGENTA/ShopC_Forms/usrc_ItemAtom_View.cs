...
namespace ShopC_Forms
{
    ...
    public partial class usrc_Atom_Item_View : UserControl
    {
        ...
        private List<TangentaDB.Doc_ShopC_Item> dsci_List = new List<TangentaDB.Doc_ShopC_Item>();
        ...
        public bool Init(TangentaDB.ShopABC x_InvoiceDB, ID x_Atom_Item_ID)
        {
            ...
            String Err = null;
            string scond = null;
            if (m_InvoiceDB.IsDocInvoice)
            {
                scond = " and discis.dQuantity > 0";
            }
            else
            {
                scond = " and dpiscis.dQuantity > 0";
            }
            if (m_InvoiceDB.Read_Doc_Atom_Item_Stock_Table(m_InvoiceDB.CurrentDocument.Doc_ID, m_Atom_Item_ID, ref dt_DocInvoice_Atom_Item_Stock_view, scond,ref Err))
            {
                if (dt_DocInvoice_Atom_Item_Stock_view.Rows.Count > 0)
                {
                    ...
                    for (int i =0;i<iCount;i++)
                    {
                        ...
                        TangentaDB.Doc_ShopC_Item dsci = new TangentaDB.Doc_ShopC_Item();
                    ...
                    TangentaDB.Doc_ShopC_Item xdsci= (TangentaDB.Doc_ShopC_Item)dsci_List[0];
                    this.txt_Atom_Item_Name.Text = xdsci.Item_UniqueName;
