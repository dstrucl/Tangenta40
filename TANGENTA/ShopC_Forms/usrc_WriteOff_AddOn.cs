...
{
    public partial class usrc_WriteOff_AddOn : UserControl
    {
        ...
        private WriteOffAddOn m_AddWriteOff = null;
        private WriteOffAddOn AddOnWriteOff
        {
            get
            {
                return m_AddWriteOff;
            }
            set
            {
                m_AddWriteOff = value;
        ...
        public bool Init(WriteOffAddOn x_AddOnWriteOff, bool bxPrint, usrc_Consumption_AddOn x_usrc_AddOn) //, int xCurrency_DecimalPlaces, decimal xGrossSum)
        {
            Enable_BankAccountTransfer(false);
            AddOnWriteOff = x_AddOnWriteOff;
            m_bPrint = bxPrint;
        ...
        //{
        //    return "[" + AddOnWriteOff.MyMethodOfPayment_DI.m_MyOrgBankAccountPayment.BankAccount + "] " + AddOnWriteOff.MyMethodOfPayment_DI.m_MyOrgBankAccountPayment.BankName;
        //}
