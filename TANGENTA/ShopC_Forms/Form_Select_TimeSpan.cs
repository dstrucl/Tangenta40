...
namespace ShopC_Forms
{
    ...
    {
        private usrc_TableOfConsumption m_usrc_ConsumptionTable;
        private usrc_TableOfConsumption.eMode Org_Mode;
        private DateTime Org_dtStartTime;
        private DateTime Org_dtEndTime;


        public Form_Select_TimeSpan(usrc_TableOfConsumption xusrc_InvoiceTable)
        {
            // TODO: Complete member initialization
            InitializeComponent();
            this.m_usrc_ConsumptionTable = xusrc_InvoiceTable;
            ...
            Org_Mode = m_usrc_ConsumptionTable.Mode;
            Org_dtStartTime = m_usrc_ConsumptionTable.dtStartTime;
            Org_dtEndTime = m_usrc_ConsumptionTable.dtEndTime;

            switch (m_usrc_ConsumptionTable.Mode)
            {
                case usrc_TableOfConsumption.eMode.All:
            ...
            this.dateTimePicker_From.Value = m_usrc_ConsumptionTable.dtStartTime;
            this.dateTimePicker_To.Value = m_usrc_ConsumptionTable.dtEndTime;
        ...
        {
            m_usrc_ConsumptionTable.SetTimeSpanParam(Org_Mode, Org_dtStartTime, Org_dtEndTime);
            this.Close();
        ...
        private void rdb_TimeSpan_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_TimeSpan.Checked)
            {
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.TimeSpan, dateTimePicker_From.Value, dateTimePicker_To.Value);
            }
            else
            {
        ...
        private void rdb_ThisYear_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_ThisYear.Checked)
            {
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.ThisYear, dtStartTime, dtEndTime);
            }
        ...
        private void rdb_All_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_All.Checked)
            {
                m_usrc_ConsumptionTable.lpar_ExtraCondition = null;
                m_usrc_ConsumptionTable.ExtraCondition = null;
                m_usrc_ConsumptionTable.SetMode(usrc_TableOfConsumption.eMode.All, lng.s_AllData.s);
            }
        }
        ...
        private void rdb_CurrentDay_CheckedChanged(object sender, EventArgs e)
        {
            ...
            { 
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.Today,dtStartTime, dtEndTime);
            }
        }
        ...
        private void rdb_LastWeek_CheckedChanged(object sender, EventArgs e)
        {
            ...
            { 
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.LastWeek,dtStartTime, dtEndTime);
            }
        }
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            if (rdb_TimeSpan.Checked)
            {
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.TimeSpan, dateTimePicker_From.Value, dtToNextDay);
            }
            this.Close();
        ...
        private void rdb_ThisWeek_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_ThisWeek.Checked)
            {
                ...
                DateTime dtEndTime = dtStartTime.AddDays(7);
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.ThisWeek, dtStartTime, dtEndTime);
            }
        ...
        private void rdb_ThisMonth_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_ThisMonth.Checked)
            {
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.ThisMonth, dtStartTime, dtEndTime);
            }
        }
        ...
        private void rdb_LastMonth_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_LastMonth.Checked)
            {
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.LastMonth, dtStartTime, dtEndTime);
            }
        }
        ...
        private void rdb_LastYear_CheckedChanged(object sender, EventArgs e)
        {
            if (rdb_LastYear.Checked)
            {
                ...
                m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.LastYear, dtStartTime, dtEndTime);
            }
...
//            m_usrc_InvoiceTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.TimeSpan, dateTimePicker_From.Value, dateTimePicker_To.Value);
            this.rdb_TimeSpan.CheckedChanged += new System.EventHandler(this.rdb_TimeSpan_CheckedChanged);
        }
...
//            m_usrc_InvoiceTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.TimeSpan, dateTimePicker_From.Value, dateTimePicker_To.Value);
        ...
        private void rdb_ForDay_CheckedChanged(object sender, EventArgs e)
        {
            ...
            m_usrc_ConsumptionTable.SetTimeSpanParam(usrc_TableOfConsumption.eMode.ForDay, xdtStart, xdtEnd);
        }
