...
namespace TangentaBooting
{
    public class Booting_06_GetBaseCurrency
    {
        ...
        public Booting_06_GetBaseCurrency(Form xfmain, Startup.Startup x_sturtup)
        {
            frm = xfmain;
            m_startup = x_sturtup;
        ...
        {
            return new startup_step(lng.s_Startup_GetBaseCurrency.s, m_startup, Booting.nav, Startup_06_GetBaseCurrency, null,eStep);
        }
