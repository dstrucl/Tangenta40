...
namespace TangentaBooting
{
    public class Booting_10_GetShopB_Items
    {
        ...
        public Booting_10_GetShopB_Items(Form xfmain, Startup.Startup x_sturtup)
        {
            frm = xfmain;
            m_startup = x_sturtup;
        ...
        {
            return new startup_step(lng.s_Startup_GetShopB_Items.s, m_startup, Booting.nav, Startup_10_GetShopB_Items,null, eStep);
        }
            ...
            switch (eExitResult)
            {
                case Navigation.eEvent.NEXT:
                    if (form is Form_Items_Samples)
                    {
                        ...
                        {
                            Transaction transaction_Startup_10_Write_ShopB_Items = DBSync.DBSync.NewTransaction("Startup_10_Write_ShopB_Items");
                            if (m_startup.sbd.Startup_10_Write_ShopB_Items((Form_Items_Samples)form, transaction_Startup_10_Write_ShopB_Items))
                            {
                                if (transaction_Startup_10_Write_ShopB_Items.Commit())
                                {
                            ...
                            {
                                transaction_Startup_10_Write_ShopB_Items.Rollback();
                                return Startup_onformresult_proc_Result.ERROR;
                            }
                        }
                        else
