...
namespace TangentaBooting
{
    public class Booting_12_GetPrinters
    {
        ...
        public Booting_12_GetPrinters(Form xfmain, Startup.Startup x_sturtup)
        {
            frm = xfmain;
            m_startup = x_sturtup;
        ...
        {
            return new startup_step(lng.s_Startup_GetPrinter.s, m_startup, Booting.nav, Startup_12_GetPrinter,null, eStep);
        }
        ...
        internal bool Startup_12_Get_Printer(Startup.Startup myStartup, ref string Err)
        {
