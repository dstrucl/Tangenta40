...
namespace TangentaBooting
{
    public class Booting_05_Check_myOrganisation_Data
    {
        ...
        public Booting_05_Check_myOrganisation_Data(Form xfmain, Startup.Startup x_sturtup)
        {
            frm = xfmain;
            m_startup = x_sturtup;
        ...
        {
            return new startup_step(lng.s_Startup_Check_myOrganisation_Data.s, m_startup, Booting.nav,
        ...
        private bool Startup_05_Show_Form_CheckInsertSampleData(Startup.Startup myStartup, NavigationButtons.Navigation xnav)
        {
