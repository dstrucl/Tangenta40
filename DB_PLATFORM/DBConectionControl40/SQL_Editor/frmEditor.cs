...
namespace SqlBuilder.Forms
{
    ...
    public class frmEditor : frmBaseForm
    {
        ...
        private List<SQL_Parameter> m_lSQL_Parameter = null;
        ...
        public frmEditor(string sql, List<SQL_Parameter> lSQL_Parameter,  string title)
        {
            ...
            this.chkBoxbPreviewSQLBeforeExecution.Checked = DBConnectionControl40.DynSettings.bPreviewSQLBeforeExecution;
        }
        ...
        public frmEditor(string ErrorMsg, string Title)
        {
            ...
            //this.chkBoxbPreviewSQLBeforeExecution.Checked = DBConnection.DynSettings.bPreviewSQLBeforeExecution;
        }
        ...
        protected override void OnLoadDelayed()
        {
            ...
            //    {
            //        foreach (SQL_Parameter sqlpar in m_lSQL_Parameter)
            //        {
            //            this.tsmi_Params_ComboBox.Items.Add(sqlpar.Name + " DBType=" + sqlpar.dbType.ToString() + " Value = ");//+ SQLTableControl.Func.sqlpar.Value
            //        }
            //    }
            //}
        ...
        {
            DBConnectionControl40.DynSettings.bPreviewSQLBeforeExecution = this.chkBoxbPreviewSQLBeforeExecution.Checked;
            Close();
            ...
            if (m_lSQL_Parameter != null)
            {
                if (m_lSQL_Parameter.Count > 0)
                {
                    ...
                    foreach (SQL_Parameter sqlpar in m_lSQL_Parameter)
                    {
                        ...
                        this.tsmi_Params_ComboBox.Items.Add(s);//+ SQLTableControl.Func.sqlpar.Value
                        iCount++;
                    }
        ...
        private string ConevrtToString_MySQLdbTypeValue(SQL_Parameter sqlpar)
        {
            return "";
        }
