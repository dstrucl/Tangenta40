...
namespace SQLTableControl
{
    ...
    {
        public bool SQLcmd_Update(DBTableControl dbTables,ref string csError)
        {
            string sqlUpdate;
        ...
        internal bool UpdateInputControls(DBTableControl dbTables,ref long ID, ref string csError)
        {
            ...
            //if (dbTables.m_con.DBType == DBConnection.eDBType.SQLITE)
            //{
                if (UpdateInputControls_SQL(dbTables, null, ref ID, ref csError))
                {
                    return true;
                }
                else
...
//            }
            ...
            //            if ((inpctrl.m_col.flags & SQLTableControl.Column.Flags.FILTER)!=0)
            //            {
  ...
  //          return bRes;
        ...
        private bool sql_check_if_not_unique_parameter(DBTableControl dbTables, SQLTableControl.Column col, List<SQL_Parameter> sqlParamList, string sqlite_set, object value, ref string Err)
        {
            if ((col.flags & SQLTableControl.Column.Flags.UNIQUE) != 0)
            {
