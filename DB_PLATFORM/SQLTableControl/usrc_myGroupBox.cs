...
namespace SQLTableControl
{
    public partial class usrc_myGroupBox : UserControl
    {
        ...
        internal bool SetEvent_RowReferenceFromTable_Check_NoChangeToOther(SQLTable pSQL_Table,List<usrc_RowReferencedFromTable> usrc_RowReferencedFromTable_List, SQLTableControl.ID_v id_v, ref bool bCancelDialog, ref ltext Instruction)
        {
