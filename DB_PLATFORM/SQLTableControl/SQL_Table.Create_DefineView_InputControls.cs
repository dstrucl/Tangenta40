...
namespace SQLTableControl
{
    partial class SQLTable
    {
        ...
        public void SetVIEW_DataGridViewImageColumns_Headers(DataGridView dgvx_Item, SQLTableControl.DBTableControl xdbTables)
        {
            foreach (DataGridViewColumn col in dgvx_Item.Columns)
            {
                Column c = this.FindColumn(col.Name);
        ...
        internal void Check_Null_Values(ref string mymsg)
        {
            foreach (Column col in Column)
            {
                if (col.nulltype == SQLTableControl.Column.nullTYPE.NOT_NULL)
                {
                ...
                {
                    //col.nulltype ==  SQLTableControl.Column.nullTYPE.NULL
                    if (col.InputControl != null)
                    {
