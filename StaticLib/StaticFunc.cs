...
namespace StaticLib
{
    ...
    public static class Func
    {
        ...
        {
            WM_USER_REDRAW_FORM = RegisterWindowMessage("SQLTableControl WM_USER_REDRAW_FORM");
        }

        public static void Set_WM_USER_GENERATE_RANDOM_INPUT()
        {
            WM_USER_GENERATE_RANDOM_INPUT = RegisterWindowMessage("SQLTableControl WM_USER_GENERATE_RANDOM_INPUT");
        }

        public static void Set_WM_USER_GENERATE_RANDOM_INPUT_OK()
        {
            WM_USER_GENERATE_RANDOM_INPUT_OK = RegisterWindowMessage("SQLTableControl WM_USER_GENERATE_RANDOM_INPUT_OK");
        }

        public static void Set_WM_DO_RANDOM_PARAM_SETTINGS_DIALOG()
        {
            bRANDOM_PARAM_SETTINGS_DIALOG_IS_RUNNING = false;
            WM_DO_RANDOM_PARAM_SETTINGS_DIALOG = RegisterWindowMessage("SQLTableControl WM_DO_RANDOM_PARAM_SETTINGS_DIALOG");
        }


        public static void Set_WM_RANDOM_PARAM_SETTINGS_DIALOG_CLOSED()
        {
            WM_RANDOM_PARAM_SETTINGS_DIALOG_CLOSED = RegisterWindowMessage("SQLTableControl WM_RANDOM_PARAM_SETTINGS_DIALOG_CLOSED");
        }

        public static void Set_WM_USER_GENERATE_RANDOM_INPUT_DONE()
        {
            WM_USER_GENERATE_RANDOM_INPUT_DONE = RegisterWindowMessage("SQLTableControl  WM_USER_GENERATE_RANDOM_INPUT_DONE");
        }
