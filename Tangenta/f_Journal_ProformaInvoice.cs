...
namespace Tangenta
{
    public static class f_Journal_ProformaInvoice
    {
        ...
        internal static bool Write(long ProformaInvoice_ID, long Atom_WorkPeriod_ID, long journal_invoice_type_id, DateTime_v issue_time, ref long Journal_ProformaInvoice_ID)
        {
            List<SQL_Parameter> lpar = new List<SQL_Parameter>();
