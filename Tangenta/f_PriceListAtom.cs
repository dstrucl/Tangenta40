...
namespace Tangenta
{
    internal static class f_Atom_PriceList
    {
        internal static bool Get(long PriceList_ID, ref long Atom_PriceList_ID)
        {
            string Err = null;
        ...
        internal static bool Get(ref Atom_ProformaInvoice_Price_Item_Stock_Data appisd, ref long Atom_PriceList_ID)
        {
            string Err = null;
