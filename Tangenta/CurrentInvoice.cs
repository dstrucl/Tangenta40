...
namespace Tangenta
{
    public class CurrentInvoice
    {
        ...
        public CurrentInvoice(InvoiceDB xInvoiceDB,DBTablesAndColumnNames xDBtcn)
        {
        ...
        internal void Set_SelectedSimpleItems(DataGridView dgv_SelectedSimpleItems,
        ...
        internal bool Insert_ProformaInvoice_Atom_Price_Items_Stock(ref Atom_ProformaInvoice_Price_Item_Stock_Data appisd, bool b_from_stock
                                                                    )
        {
        ...
        private bool Get_Atom_ProformaInvoice_Price_Item_Stock(ref Atom_ProformaInvoice_Price_Item_Stock_Data appisd, bool b_from_stock)
        {
            ...
            if (Get_Atom_Price_Item(ref appisd))
            {
                ...
                int decimal_places = Program.Get_BaseCurrency_DecimalPlaces();
        ...
        internal bool Update_Customer_Remove()
        {
        ...
        internal bool Remove_usrc_Atom_Item_Factory_Items(usrc_Atom_Item x_usrc_Atom_Item, usrc_Atom_ItemsList usrc_Atom_ItemsList)
        {
        ...
        internal bool Save(ref long xProformaInvoice_ID,usrc_Payment.ePaymentType ePaymentType, string p1, string p2, string p3,ref int xNumberInFinancialYear)
        {
            List<SQL_Parameter> lpar = new List<SQL_Parameter>();
        ...
        internal bool Update_Customer_Person(long Customer_Person_ID, ref long_v xAtom_Customer_Person_ID_v)
        {
        ...
        internal bool Update_Customer_Org(long Customer_Org_ID, ref long_v xAtom_Customer_Org_ID_v)
        {
...
//                }
        ...
        internal bool SetInvoiceTime(DateTime_v issue_time)
        {
            ...
            { 
                ...
                return f_Journal_ProformaInvoice.Write(this.ProformaInvoice_ID, Program.Atom_WorkPeriod_ID, Program.JOURNAL_ProformaInvoice_Type_definitions.InvoiceTime.ID, issue_time, ref Journal_ProformaInvoice_ID);
            }
            else
            {
        ...
        internal bool Storno(bool bStorno, string sReason)
        {
            string sBit= "0";
            if (bStorno)
            {
            ...
            if (DBSync.DBSync.ExecuteNonQuerySQL(sql, null, ref ores, ref Err))
            {
                ...
                if (f_Journal_Invoice.Write(Invoice_ID,Program.Atom_WorkPeriod_ID,Form_Storno.const_Storno,null,null,ref JOURNAL_Invoice_ID))
                {
                    if (f_Journal_Invoice.Write(Invoice_ID, Program.Atom_WorkPeriod_ID, Form_Storno.const_Storno_with_description, sReason, null, ref JOURNAL_Invoice_ID))
                    {
                        return true;
                    }
                }
