...
namespace Tangenta
{
    public partial class PersonAccount_EditForm : Form
    {
        ...
        public PersonAccount_EditForm(SQLTableControl.DBTableControl xdbTables, SQLTable xtbl,string xColumnOrderBy)
        {
            InitializeComponent();
            dbTables = xdbTables;
            tbl = xtbl;
        ...
        public PersonAccount_EditForm(SQLTableControl.DBTableControl xdbTables, SQLTable xtbl, string xColumnOrderBy, long ID)
        {
            InitializeComponent();
            dbTables = xdbTables;
            tbl = xtbl;
