...
namespace Tangenta
{
    public static class f_JOURNAL_Stock
    {
        ...
        internal static bool Get_JOURNAL_Stock_Type_ID()
        {
        ...
        internal static bool Get(long Stock_id,long stock_type_id,DateTime dEventTime, decimal dQuantity, ref long_v JOURNAL_Stock_ID)
        {
            ...
            long Atom_WorkPeriod_id = Program.Atom_WorkPeriod_ID;
