...
namespace LayoutManager
{
    public partial class MyControl : IEquatable<MyControl>
    {
        ...
        internal void Init(/*HelpWizzardTag xHlpWizTag, usrc_Help xuH,*/ hctrl xhc, int iLevel, MyControl parent, ref SysImageListHelper helperControlType)
        {
            ...
            //    xfrm_Layout = uH.hlp_dlg.usrc_web_Help1.frm_Layout;
            //}
        ...
        //        }
        //        else if (xfrm_Layout != null)
        //        {
        //            Control_Selected = xfrm_Layout.MyControl_Selected;
        //        }
        ...
        private bool Get_MyControl_Selected()
        {
            ...
            if (xfrm_Layout != null)
            {
                return (xfrm_Layout.MyControl_Selected != null);
            }
            else
            {
        ...
        internal void CreateImageOfLinkedControls()
        {
            ...
            if (this.hc.ctrlbmp != null)
            {
                ...
                if (xfrm_Layout != null)
                {
                    //if (xfrm_Layout.usrc_EditControlWizzard1.my_Control == this)
                    //{
                    //    xfrm_Layout.usrc_EditControlWizzard1.Set_pic_Control(this.hc);
                    //}
                }
                else
                {
