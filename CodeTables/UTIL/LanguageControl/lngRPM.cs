...
namespace LanguageControl
{
    public static class lngRPM
    {
        ...
        public static ltext s_Form_TemplateTokens_Caption = new ltext("Template tokens", "Ključne spremenljvke za izdelavo predlog");
        public static ltext s_Default = new ltext("Default", "Privzeto");
        ...
        public static ltext s_Roll_paper_58_mm_description = new ltext("Roll paper 58 mm", "Papir v roli 58 mm");
        ...
        public static ltext s_btn_Select_BankAccount = new ltext("Select your bank account", "Izberite vaš bančni račun");
        public static ltext s_Invoice_Issue = new ltext("Issue an invoice", "Izdaj račun");
        public static ltext s_ProformaInvoice_Issue = new ltext("Issue an offer", "Izdaj ponudbo");
