...
//    #region DBConnectionControl.ConnectionINfo_Form

//    public static ltext s_ConnectionDialogInfo_Titel = new ltext("DataBase Connection Info",
//                                                                 "Podatki o povezavi na bazo podatkov");

//    public static ltext s_AuthenticationTypeWindows  = new ltext("Windows Authentication",
//                                                                 "Windows prijava");

//    public static ltext s_AuthenticationTypeServer = new ltext("Server Authentication (user name and password)",
//                                                               "Strežniška prijava (uporabniško ime in geslo)");
//    public static ltext s_lbl_Server = new ltext("Server:",
//                                                 "Strežnik:");
...
//    public static ltext s_Finish =new ltext ("Finish",
//                                      "Končaj");
...
//    public static ltext s_Connection_to_server  = new ltext ("Connection to server \"",
//                                                      "Prijava na strežnik ");
