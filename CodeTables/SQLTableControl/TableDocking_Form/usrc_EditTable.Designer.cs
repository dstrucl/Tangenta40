namespace CodeTables.TableDocking_Form
{
    partial class usrc_EditTable
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.usrc_EditRow.before_New += new CodeTables.TableDocking_Form.usrc_EditRow.delegate_before_New(this.usrc_EditRow_before_New);
            this.usrc_EditRow.after_New += new CodeTables.TableDocking_Form.usrc_EditRow.delegate_after_New(this.usrc_EditRow_after_New);
            ...
            this.usrc_EditRow.after_UpdateDataBase += new CodeTables.TableDocking_Form.usrc_EditRow.delegate_after_UpdateDataBase(this.usrc_EditRow_after_UpdateDataBase);
            this.usrc_EditRow.RowReferenceFromTable_Check_NoChangeToOther += new CodeTables.TableDocking_Form.usrc_EditRow.delegate_RowReferenceFromTable_Check_NoChangeToOther(this.usrc_EditRow_RowReferenceFromTable_Check_NoChangeToOther);
            this.usrc_EditRow.after_FillDataInputControl += new CodeTables.TableDocking_Form.usrc_EditRow.delegate_after_FillDataInputControl(this.usrc_EditRow_after_FillDataInputControl);
            this.usrc_EditRow.Update += new CodeTables.TableDocking_Form.usrc_EditRow.delegate_Update(this.usrc_EditRow_Update);
            // 
            // dgvx_Table
            // 
