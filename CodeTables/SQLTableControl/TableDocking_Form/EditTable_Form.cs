...
namespace CodeTables
{
    public partial class EditTable_Form : Form
    {
        ...
        public EditTable_Form(DBTableControl dbTables,TransactionLog_delegates xTransactionLog_delegates,SQLTable tbl, TableDockingForm dtF,Globals.delegate_SetControls xSetControls, bool bReadOnly,NavigationButtons.Navigation xnav)
        {
            ...
            usrc_EditRow.Init(dbTables, xTransactionLog_delegates, tbl, xSetControls, bReadOnly,xnav);
        }
