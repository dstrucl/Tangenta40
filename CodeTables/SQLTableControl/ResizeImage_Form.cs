...
namespace CodeTables
{
    public partial class ResizeImage_Form : Form
    {
        ...
        {
            this.lbl_SourceSize.Text = lng.s_Format.s + "=" +StaticLib.Func.GetImageFormatName(m_OrgImage) + ", " + lng.s_Size.s + "=" + DBTypes.DBtypesFunc.GetObjectSize(m_OrgImage).ToString("n") + " " + lng.s_Bytes.s;
