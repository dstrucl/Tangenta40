...
namespace DBConnectionControl40
{
	...
	public class CreateDataBase_Form : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // usrc_Help1
            // 
            this.usrc_Help1.Location = new System.Drawing.Point(291, 307);
            this.usrc_Help1.Name = "usrc_Help1";
            this.usrc_Help1.Size = new System.Drawing.Size(75, 22);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            case Process_CreateDatabase_Timer.Process_CreateDatabase_ENUM.STOP_CREATE:
                ...
                if ((strDir.Length == 0)||(strRoot.Length==0))
                {
                    ...
                    {
                        DialogResult dWarningResult = MessageBox.Show(this,lng.s_OnServerDatabaseConstructionFileInstructions.s,lng.s_Warning.s,MessageBoxButtons.YesNoCancel,MessageBoxIcon.Warning);
                    ...
                    {
                        DialogResult dWarningResult = MessageBox.Show(this,lng.s_OnLocalComputerDatabaseConstructionFileInstructions.s,lng.s_Warning.s,MessageBoxButtons.YesNoCancel,MessageBoxIcon.Warning);
                        switch (dWarningResult)
                        {
                            case DialogResult.Yes:
                                eRes = eSelectDataBaseFileTYPE.E_SELECT_WITH_FILE_BROWSER;
