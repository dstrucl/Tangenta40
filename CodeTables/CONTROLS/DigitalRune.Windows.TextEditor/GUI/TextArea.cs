  ...
  public class TextArea : Control
  {
    ...
    public bool HandleProcessDialogKey(object sender)
    {
        if (sender!=null)
        {
            ...
            {
                ToolStripMenuItem xToolStripMenuItem = (ToolStripMenuItem)sender;
                Keys keyData = xToolStripMenuItem.ShortcutKeys;
    ...
    private void InitializeComponent()
    {
        ...
        this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextArea_KeyPress);
