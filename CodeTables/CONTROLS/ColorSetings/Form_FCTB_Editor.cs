...
namespace ColorSettings
{
    ...
    public partial class Form_FCTB_Editor : Form
    {
        ...
        public Form_FCTB_Editor()
        {
            ...
            this.Text = Sheme.slng_Form_FCTB_Editor_Caption;
        }
        ...
        private void Form_FCTB_Editor_Load(object sender, EventArgs e)
        {
            //Sheme Create Source File
            string FileName = null;
            if (Sheme.CreateSourceFile(ref FileName))
            {
