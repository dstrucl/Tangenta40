...
namespace Tangenta
{
    public class xPriceList
    {
        ...
        internal bool Get_PriceLists_of_Currency(long Currency_ID, ref int iCount, ref string Err)
        {
...
//            where PriceList.Valid = 1  and PriceList.Currency_ID = " + Currency_ID.ToString();
        ...
        internal bool Get_PriceList(long PriceList_ID, ref int iCount, ref string Err)
        {
            string sql_select_PriceList = @"SELECT 
              PriceList.ID,
              PriceList.Name,
