...
namespace DigitalRune.Windows.TextEditor
{
  partial class TextEditorControl
  {
    ...
    private void InitializeComponent()
    {
        ...
        this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.TextEditorControl_KeyPress);
        this.ResumeLayout(false);

    }

    private void TextEditorControl_KeyPress(object sender, KeyPressEventArgs e)
    {
