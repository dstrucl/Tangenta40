...
namespace DataGridView_2xls_base
{
    public partial class DataGridView2xls_base : DataGridView
    {
        ...
        public bool DataGridViewWithRowNumber
        {
            ...
            set
            {
                m_DataGridViewWithRowNumber = value;
        ...
        void DataGridView_2xls_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                if ((e.RowIndex == -1) && (e.ColumnIndex == -1))
                {
                    if (MessageBox.Show(static_lng_text.lng_s_SaveSelectedRowsToExcelFile_s, "?", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
                    {
                        Excell_base excell = new Excell_base();
                ...
                else
                {
                    if (e.ColumnIndex == -1)
                    {
                        if (MessageBox.Show(static_lng_text.lng_s_ShowRowNumbers_s + "?", "?", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
                        {
